...
export const ProductCatalog: React.FC = () => {
  ...
  return (
    <section id="productos" className="py-20 sm:py-28 bg-white relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Filter Controls Bar */}
        <div className="mb-10 flex flex-col md:flex-row items-center justify-between gap-4 bg-slate-50 p-3 sm:p-4 rounded-2xl border border-slate-200">
          {/* Category Tabs */}
          ...
          <div className="relative w-full md:w-72">
            ...
            <input
              ...
              className="w-full bg-white border border-slate-300 text-slate-900 placeholder-slate-400 text-xs sm:text-sm rounded-xl pl-9 pr-4 py-2 focus:outline-none focus:border-slate-950 focus:ring-1 focus:ring-slate-950 transition-colors"
            />
          </div>
        </div>
        ...
        {filteredProducts.length > 0 ? (
          ...
          <div className="text-center py-16 bg-slate-50 rounded-2xl border border-slate-200 p-8">
            ...
            <button
              ...
              className="text-xs font-semibold px-4 py-2 bg-slate-950 text-white rounded-lg hover:bg-slate-800"
            >
              Restablecer filtros
            </button>
          </div>
        ...
        <div className="mt-14 p-6 sm:p-8 rounded-2xl bg-slate-950 border border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-6 shadow-xl">
          <div>
          ...
          <a
            ...
            className="flex-shrink-0 inline-flex items-center gap-2 bg-white hover:bg-slate-100 text-slate-950 font-bold px-5 py-3 rounded-xl text-xs sm:text-sm transition-colors shadow-sm"
          >
