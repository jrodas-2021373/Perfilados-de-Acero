      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-14">
          ...
          <div className="p-6 rounded-2xl bg-slate-50 border border-slate-200 text-center flex flex-col items-center justify-between hover:border-slate-300 shadow-sm transition-all">
            ...
            <h3 className="font-bold text-slate-950 text-base mb-1">WhatsApp y Teléfono</h3>
            <p className="text-xs text-slate-500 mb-4">Atención comercial inmediata</p>
            <a
          ...
          <div className="p-6 rounded-2xl bg-slate-50 border border-slate-200 text-center flex flex-col items-center justify-between hover:border-slate-300 shadow-sm transition-all">
            ...
            <p className="text-xs text-slate-500 mb-4">Cotizaciones formales y planos</p>
            <a
              href={`mailto:${companyInfo.email}`}
              className="text-xs sm:text-sm font-bold text-slate-900 hover:underline transition-colors break-all"
            >
              {companyInfo.email}
            </a>
          </div>
          ...
          <div className="p-6 rounded-2xl bg-slate-50 border border-slate-200 text-center flex flex-col items-center justify-between hover:border-slate-300 shadow-sm transition-all">
            ...
            <h3 className="font-bold text-slate-950 text-base mb-1">Ubicación y Despacho</h3>
            <p className="text-xs text-slate-500 mb-2">{companyInfo.location}</p>
          ...
          <div className="p-6 rounded-2xl bg-slate-50 border border-slate-200 text-center flex flex-col items-center justify-between hover:border-slate-300 shadow-sm transition-all">
            ...
            <h3 className="font-bold text-slate-950 text-base mb-1">Horario de Atención</h3>
